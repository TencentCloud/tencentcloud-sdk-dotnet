...
namespace TencentCloud.Tke.V20180525.Models
{
    ...
    public class DescribeOpenPolicyListResponse : AbstractModel
    {
        ...
        public OpenPolicyInfo[] OpenPolicyInfoList{ get; set; }

        /// <summary>
        /// 集群内是否安装了gatekeeper addon
        /// </summary>
        [JsonProperty("GatekeeperStatus")]
        public long? GatekeeperStatus{ get; set; }
