...
namespace TencentCloud.Tke.V20180525.Models
{
    ...
    public class SchedulerPolicyConfig : AbstractModel
    {
        ...
        public SchedulerPluginConfigs[] PluginConfigs{ get; set; }

        /// <summary>
        /// 插件配置
        /// </summary>
        [JsonProperty("PluginSet")]
        public PluginSet PluginSet{ get; set; }
