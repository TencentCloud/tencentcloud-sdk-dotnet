...
namespace TencentCloud.Tke.V20180525.Models
{
    ...
    public class DescribeClusterInspectionResultsOverviewResponse : AbstractModel
    {
        ...
        public KubeJarvisStateDiagnosticOverview[] Diagnostics{ get; set; }

        /// <summary>
        /// 集群诊断结果概览
        /// 注意：此字段可能返回 null，表示取不到有效值。
        /// </summary>
        [JsonProperty("InspectionOverview")]
        public KubeJarvisStateInspectionOverview[] InspectionOverview{ get; set; }
