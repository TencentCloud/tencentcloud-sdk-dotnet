...
namespace TencentCloud.Ams.V20201229
{
   ...
   public class AmsClient : AbstractClient{
       ...
       private const string sdkVersion = "SDK_NET_3.0.1160";
        ...
        public Task<CreateAudioModerationSyncTaskResponse> CreateAudioModerationSyncTask(CreateAudioModerationSyncTaskRequest req)
        {
            return InternalRequestAsync<CreateAudioModerationSyncTaskResponse>(req, "CreateAudioModerationSyncTask");
        }
