...
namespace TencentCloud.Tsf.V20180326.Models
{
    ...
    public class ContainerInstanceResourceConfig : AbstractModel
    {
        ...
        /// 注意：此字段可能返回 null，表示取不到有效值。
        /// </summary>
        [JsonProperty("MasterNumLimit")]
        public long? MasterNumLimit{ get; set; }

        /// <summary>
        /// SSH 模式时，前端应该限制用户填的最高数量的 node 主机信息
        /// 注意：此字段可能返回 null，表示取不到有效值。
        /// </summary>
        [JsonProperty("NodeNumLimitPerSetup")]
        public long? NodeNumLimitPerSetup{ get; set; }
