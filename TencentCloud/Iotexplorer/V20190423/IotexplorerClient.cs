...
namespace TencentCloud.Iotexplorer.V20190423
{
   ...
   public class IotexplorerClient : AbstractClient{
       ...
       private const string sdkVersion = "SDK_NET_3.0.1466";
        ...
        /// 用于绑定一个产品和智能体。
        /// </summary>
        /// <param name="req"><see cref="BindTWeTalkAIBotRequest"/></param>
        /// <returns><see cref="BindTWeTalkAIBotResponse"/></returns>
        public Task<BindTWeTalkAIBotResponse> BindTWeTalkAIBot(BindTWeTalkAIBotRequest req)
        {
        ...
        /// </summary>
        /// <param name="req"><see cref="BindUserDeviceRequest"/></param>
        /// <returns><see cref="BindUserDeviceResponse"/></returns>
        public Task<BindUserDeviceResponse> BindUserDevice(BindUserDeviceRequest req)
        {
            return InternalRequestAsync<BindUserDeviceResponse>(req, "BindUserDevice");
        }
        ...
        /// <param name="req"><see cref="BindUserDeviceRequest"/></param>
        /// <returns><see cref="BindUserDeviceResponse"/></returns>
        public BindUserDeviceResponse BindUserDeviceSync(BindUserDeviceRequest req)
        {
            return InternalRequestAsync<BindUserDeviceResponse>(req, "BindUserDevice")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </summary>
        /// <param name="req"><see cref="CallDeviceRRPCSyncRequest"/></param>
        /// <returns><see cref="CallDeviceRRPCSyncResponse"/></returns>
        public Task<CallDeviceRRPCSyncResponse> CallDeviceRRPCSync(CallDeviceRRPCSyncRequest req)
        {
            return InternalRequestAsync<CallDeviceRRPCSyncResponse>(req, "CallDeviceRRPCSync");
        }
        ...
        /// <param name="req"><see cref="CallDeviceRRPCSyncRequest"/></param>
        /// <returns><see cref="CallDeviceRRPCSyncResponse"/></returns>
        public CallDeviceRRPCSyncResponse CallDeviceRRPCSyncSync(CallDeviceRRPCSyncRequest req)
        {
            return InternalRequestAsync<CallDeviceRRPCSyncResponse>(req, "CallDeviceRRPCSync")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// 用于新增TWeTalk智能体。
        /// </summary>
        /// <param name="req"><see cref="CreateTWeTalkAIBotRequest"/></param>
        /// <returns><see cref="CreateTWeTalkAIBotResponse"/></returns>
        public Task<CreateTWeTalkAIBotResponse> CreateTWeTalkAIBot(CreateTWeTalkAIBotRequest req)
        {
            return InternalRequestAsync<CreateTWeTalkAIBotResponse>(req, "CreateTWeTalkAIBot");
        }
        ...
        /// <param name="req"><see cref="CreateTWeTalkAIBotRequest"/></param>
        /// <returns><see cref="CreateTWeTalkAIBotResponse"/></returns>
        public CreateTWeTalkAIBotResponse CreateTWeTalkAIBotSync(CreateTWeTalkAIBotRequest req)
        {
            return InternalRequestAsync<CreateTWeTalkAIBotResponse>(req, "CreateTWeTalkAIBot")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// <returns><see cref="CreateTWeTalkProductConfigResponse"/></returns>
        public Task<CreateTWeTalkProductConfigResponse> CreateTWeTalkProductConfig(CreateTWeTalkProductConfigRequest req)
        {
        ...
        /// 用于删除TWeTalk智能体。
        /// </summary>
        /// <param name="req"><see cref="DeleteTWeTalkAIBotRequest"/></param>
        /// <returns><see cref="DeleteTWeTalkAIBotResponse"/></returns>
        public Task<DeleteTWeTalkAIBotResponse> DeleteTWeTalkAIBot(DeleteTWeTalkAIBotRequest req)
        {
        ...
        /// 查询实例概览详情。
        /// </summary>
        /// <param name="req"><see cref="DescribeLicenseOverviewRequest"/></param>
        /// <returns><see cref="DescribeLicenseOverviewResponse"/></returns>
        public Task<DescribeLicenseOverviewResponse> DescribeLicenseOverview(DescribeLicenseOverviewRequest req)
        {
            return InternalRequestAsync<DescribeLicenseOverviewResponse>(req, "DescribeLicenseOverview");
        }
        ...
        /// <param name="req"><see cref="DescribeLicenseOverviewRequest"/></param>
        /// <returns><see cref="DescribeLicenseOverviewResponse"/></returns>
        public DescribeLicenseOverviewResponse DescribeLicenseOverviewSync(DescribeLicenseOverviewRequest req)
        {
            return InternalRequestAsync<DescribeLicenseOverviewResponse>(req, "DescribeLicenseOverview")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// 用于查询TWeTalk智能体详情。
        /// </summary>
        /// <param name="req"><see cref="DescribeTWeTalkAIBotRequest"/></param>
        /// <returns><see cref="DescribeTWeTalkAIBotResponse"/></returns>
        public Task<DescribeTWeTalkAIBotResponse> DescribeTWeTalkAIBot(DescribeTWeTalkAIBotRequest req)
        {
        ...
        /// </summary>
        /// <param name="req"><see cref="DescribeTWeTalkProductConfigRequest"/></param>
        /// <returns><see cref="DescribeTWeTalkProductConfigResponse"/></returns>
        public Task<DescribeTWeTalkProductConfigResponse> DescribeTWeTalkProductConfig(DescribeTWeTalkProductConfigRequest req)
        {
            return InternalRequestAsync<DescribeTWeTalkProductConfigResponse>(req, "DescribeTWeTalkProductConfig");
        }
        ...
        /// <param name="req"><see cref="DescribeTWeTalkProductConfigRequest"/></param>
        /// <returns><see cref="DescribeTWeTalkProductConfigResponse"/></returns>
        public DescribeTWeTalkProductConfigResponse DescribeTWeTalkProductConfigSync(DescribeTWeTalkProductConfigRequest req)
        {
            return InternalRequestAsync<DescribeTWeTalkProductConfigResponse>(req, "DescribeTWeTalkProductConfig")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// 用于查询TWeTalk智能体列表。
        /// </summary>
        /// <param name="req"><see cref="GetTWeTalkAIBotListRequest"/></param>
        /// <returns><see cref="GetTWeTalkAIBotListResponse"/></returns>
        public Task<GetTWeTalkAIBotListResponse> GetTWeTalkAIBotList(GetTWeTalkAIBotListRequest req)
        {
        ...
        /// </summary>
        /// <param name="req"><see cref="GetTWeTalkProductConfigListRequest"/></param>
        /// <returns><see cref="GetTWeTalkProductConfigListResponse"/></returns>
        public Task<GetTWeTalkProductConfigListResponse> GetTWeTalkProductConfigList(GetTWeTalkProductConfigListRequest req)
        {
        ...
        /// 用于修改TWeTalk智能体。
        /// </summary>
        /// <param name="req"><see cref="ModifyTWeTalkAIBotRequest"/></param>
        /// <returns><see cref="ModifyTWeTalkAIBotResponse"/></returns>
        public Task<ModifyTWeTalkAIBotResponse> ModifyTWeTalkAIBot(ModifyTWeTalkAIBotRequest req)
        {
            return InternalRequestAsync<ModifyTWeTalkAIBotResponse>(req, "ModifyTWeTalkAIBot");
        }
        ...
        /// <param name="req"><see cref="ModifyTWeTalkAIBotRequest"/></param>
        /// <returns><see cref="ModifyTWeTalkAIBotResponse"/></returns>
        public ModifyTWeTalkAIBotResponse ModifyTWeTalkAIBotSync(ModifyTWeTalkAIBotRequest req)
        {
            return InternalRequestAsync<ModifyTWeTalkAIBotResponse>(req, "ModifyTWeTalkAIBot")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// <returns><see cref="ModifyTWeTalkProductConfigResponse"/></returns>
        public Task<ModifyTWeTalkProductConfigResponse> ModifyTWeTalkProductConfig(ModifyTWeTalkProductConfigRequest req)
        {
        ...
        /// </summary>
        /// <param name="req"><see cref="RevokeBindUserDeviceRequest"/></param>
        /// <returns><see cref="RevokeBindUserDeviceResponse"/></returns>
        public Task<RevokeBindUserDeviceResponse> RevokeBindUserDevice(RevokeBindUserDeviceRequest req)
        {
            return InternalRequestAsync<RevokeBindUserDeviceResponse>(req, "RevokeBindUserDevice");
        }
        ...
        /// <param name="req"><see cref="RevokeBindUserDeviceRequest"/></param>
        /// <returns><see cref="RevokeBindUserDeviceResponse"/></returns>
        public RevokeBindUserDeviceResponse RevokeBindUserDeviceSync(RevokeBindUserDeviceRequest req)
        {
            return InternalRequestAsync<RevokeBindUserDeviceResponse>(req, "RevokeBindUserDevice")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// 用于解除一个产品和智能体的绑定。
        /// </summary>
        /// <param name="req"><see cref="UnbindTWeTalkAIBotRequest"/></param>
        /// <returns><see cref="UnbindTWeTalkAIBotResponse"/></returns>
        public Task<UnbindTWeTalkAIBotResponse> UnbindTWeTalkAIBot(UnbindTWeTalkAIBotRequest req)
        {
