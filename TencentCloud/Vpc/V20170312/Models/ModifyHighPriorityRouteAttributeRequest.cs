...
namespace TencentCloud.Vpc.V20170312.Models
{
    ...
    public class ModifyHighPriorityRouteAttributeRequest : AbstractModel
    {
        ...
        /// 高优路由表条目修改属性。
        /// </summary>
        [JsonProperty("HighPriorityModifyItems")]
        public HighPriorityModifyItem[] HighPriorityModifyItems{ get; set; }
