...
namespace TencentCloud.Vpc.V20170312.Models
{
    ...
    public class DesignatedZoneInfoDict : AbstractModel
    {
        ...
        /// 可用区名称
        /// </summary>
        [JsonProperty("DesignatedZoneName")]
        public string DesignatedZoneName{ get; set; }

        /// <summary>
        /// 可用区类型
        /// </summary>
        [JsonProperty("DesignatedZoneType")]
        public string DesignatedZoneType{ get; set; }
