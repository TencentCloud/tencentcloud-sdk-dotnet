...
namespace TencentCloud.Vpc.V20170312.Models
{
    ...
    public class ModifyHighPriorityRouteECMPAlgorithmRequest : AbstractModel
    {
        ...
        /// 高优路由表HASH策略。
        /// </summary>
        [JsonProperty("RouteECMPAlgorithms")]
        public RouteECMPAlgorithm[] RouteECMPAlgorithms{ get; set; }
