...
namespace TencentCloud.Tiia.V20190529.Models
{
    ...
    public class DetectLabelBetaResponse : AbstractModel
    {
        ...
        /// 注意：此字段可能返回 null，表示取不到有效值。
        /// </summary>
        [JsonProperty("NoneCamLabels")]
        public DetectLabelItem[] NoneCamLabels{ get; set; }

        /// <summary>
        /// 识别结果
        /// 注意：此字段可能返回 null，表示取不到有效值。
        /// </summary>
        [JsonProperty("LocationLabels")]
        public Product[] LocationLabels{ get; set; }
