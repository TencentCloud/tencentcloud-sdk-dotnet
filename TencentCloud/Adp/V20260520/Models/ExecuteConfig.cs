...
namespace TencentCloud.Adp.V20260520.Models
{
    ...
    public class ExecuteConfig : AbstractModel
    {
        ...
        public AppTriggerPromptExecuteConfig PromptConfig{ get; set; }

        /// <summary>
        /// <p>工作流配置</p>
        /// </summary>
        [JsonProperty("WorkflowConfig")]
        public AppTriggerWorkflowExecuteConfig WorkflowConfig{ get; set; }
