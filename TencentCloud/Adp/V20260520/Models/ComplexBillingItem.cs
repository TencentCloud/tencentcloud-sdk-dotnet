...
namespace TencentCloud.Adp.V20260520.Models
{
    ...
    public class ComplexBillingItem : AbstractModel
    {
        
        /// <summary>
        /// <p>复合计费维度信息</p>
        /// </summary>
        [JsonProperty("BillingAttributeList")]
        public BillingAttribute[] BillingAttributeList{ get; set; }
