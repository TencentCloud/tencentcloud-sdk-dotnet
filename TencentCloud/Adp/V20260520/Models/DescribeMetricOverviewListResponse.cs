...
namespace TencentCloud.Adp.V20260520.Models
{
    ...
    public class DescribeMetricOverviewListResponse : AbstractModel
    {
        ...
        public MetricOverview[] MetricList{ get; set; }
        ...
        {
            this.SetParamArrayObj(map, prefix + "MetricList.", this.MetricList);
