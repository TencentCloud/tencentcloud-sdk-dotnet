...
namespace TencentCloud.Mrs.V20200910.Models
{
    ...
    public class FamilyHistory : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("RelativeMember")]
        public string RelativeMember{ get; set; }

        /// <summary>
        /// 家族肿瘤史
        /// 注意：此字段可能返回 null，表示取不到有效值。
        /// </summary>
        [JsonProperty("RelativeCancer")]
        public string RelativeCancer{ get; set; }

        /// <summary>
        /// 家族遗传史
        /// 注意：此字段可能返回 null，表示取不到有效值。
        /// </summary>
        [JsonProperty("Genetic")]
