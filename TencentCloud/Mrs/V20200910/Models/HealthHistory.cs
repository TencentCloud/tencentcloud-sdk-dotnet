...
namespace TencentCloud.Mrs.V20200910.Models
{
    ...
    public class HealthHistory : AbstractModel
    {
        ...
        /// 注意：此字段可能返回 null，表示取不到有效值。
        /// </summary>
        [JsonProperty("MarryHistory")]
        public MarryHistory MarryHistory{ get; set; }
        ...
        public MenstrualHistory MenstrualHistory{ get; set; }
