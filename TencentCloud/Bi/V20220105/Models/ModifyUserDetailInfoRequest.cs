...
namespace TencentCloud.Bi.V20220105.Models
{
    ...
    public class ModifyUserDetailInfoRequest : AbstractModel
    {
        ...
        public long?[] UserGroupIdList{ get; set; }
        ...
        public override void ToMap(Dictionary<string, string> map, string prefix)
        {
            ...
            this.SetParamArraySimple(map, prefix + "UserGroupIdList.", this.UserGroupIdList);
        }
    }
}
