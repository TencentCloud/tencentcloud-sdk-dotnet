...
namespace TencentCloud.Fwm.V20250611.Models
{
    ...
    public class DescribeStrategyDispatchStatusResponse : AbstractModel
    {
        ...
        /// 下发规则组数量
        /// </summary>
        [JsonProperty("RuleGroupNum")]
        public long? RuleGroupNum{ get; set; }
        ...
        public string[] DispatchStrategyList{ get; set; }
