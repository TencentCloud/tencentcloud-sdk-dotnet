...
namespace TencentCloud.Clb.V20180317.Models
{
    ...
    public class ServiceProviderModelItem : AbstractModel
    {
        
        /// <summary>
        /// <p>关联的模型路由实例列表</p>
        /// </summary>
        [JsonProperty("AssociatedModelRouters")]
        public AssociatedModelRouterItem[] AssociatedModelRouters{ get; set; }
        ...
        /// 注意：此字段可能返回 null，表示取不到有效值。
        /// </summary>
        [JsonProperty("ProbedInputModalities")]
        public string[] ProbedInputModalities{ get; set; }
