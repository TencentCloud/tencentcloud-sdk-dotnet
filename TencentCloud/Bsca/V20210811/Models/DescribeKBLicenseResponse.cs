...
namespace TencentCloud.Bsca.V20210811.Models
{
    ...
    public class DescribeKBLicenseResponse : AbstractModel
    {
        ...
        public LicenseUnion[] LicenseList{ get; set; }

        /// <summary>
        /// 用于匹配的License表达式
        /// </summary>
        [JsonProperty("NormalizedLicenseExpression")]
        public string NormalizedLicenseExpression{ get; set; }
