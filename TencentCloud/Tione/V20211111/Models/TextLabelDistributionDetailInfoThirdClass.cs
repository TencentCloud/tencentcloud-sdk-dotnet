...
namespace TencentCloud.Tione.V20211111.Models
{
    ...
    public class TextLabelDistributionDetailInfoThirdClass : AbstractModel
    {
        ...
        public TextLabelDistributionDetailInfoFourthClass[] ChildLabelList{ get; set; }
        ...
        public override void ToMap(Dictionary<string, string> map, string prefix)
        {
            ...
            this.SetParamArrayObj(map, prefix + "ChildLabelList.", this.ChildLabelList);
        }
    }
}
