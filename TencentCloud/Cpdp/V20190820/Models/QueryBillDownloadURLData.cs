...
namespace TencentCloud.Cpdp.V20190820.Models
{
    ...
    public class QueryBillDownloadURLData : AbstractModel
    {
        ...
        /// 注意：此字段可能返回 null，表示取不到有效值。
        /// </summary>
        [JsonProperty("OriginalBillDownloadURL")]
        public string OriginalBillDownloadURL{ get; set; }
