...
namespace TencentCloud.Cpdp.V20190820.Models
{
    ...
    public class QueryContractRequest : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("ContractQueryMode")]
        public string ContractQueryMode{ get; set; }
        ...
        public override void ToMap(Dictionary<string, string> map, string prefix)
        {
            ...
            this.SetParamSimple(map, prefix + "ContractQueryMode", this.ContractQueryMode);
