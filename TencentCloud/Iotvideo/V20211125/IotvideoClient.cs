...
namespace TencentCloud.Iotvideo.V20211125
{
   ...
   public class IotvideoClient : AbstractClient{
       ...
       private const string sdkVersion = "SDK_NET_3.0.1144";
        ...
        public Task<CallTRTCDeviceResponse> CallTRTCDevice(CallTRTCDeviceRequest req)
        {
            return InternalRequestAsync<CallTRTCDeviceResponse>(req, "CallTRTCDevice");
        }
        ...
        public Task<DescribeAccountResponse> DescribeAccount(DescribeAccountRequest req)
        {
            return InternalRequestAsync<DescribeAccountResponse>(req, "DescribeAccount");
        }
        ...
        public Task<DescribeBonusesResponse> DescribeBonuses(DescribeBonusesRequest req)
        {
            return InternalRequestAsync<DescribeBonusesResponse>(req, "DescribeBonuses");
        }
        ...
        public Task<DescribeDeviceDataStatsResponse> DescribeDeviceDataStats(DescribeDeviceDataStatsRequest req)
        {
            return InternalRequestAsync<DescribeDeviceDataStatsResponse>(req, "DescribeDeviceDataStats");
        }
        ...
        public Task<DescribeMessageDataStatsResponse> DescribeMessageDataStats(DescribeMessageDataStatsRequest req)
        {
            return InternalRequestAsync<DescribeMessageDataStatsResponse>(req, "DescribeMessageDataStats");
        }
        ...
        public Task<DescribePushChannelResponse> DescribePushChannel(DescribePushChannelRequest req)
        {
            return InternalRequestAsync<DescribePushChannelResponse>(req, "DescribePushChannel");
        }
        ...
        public Task<ModifyPushChannelResponse> ModifyPushChannel(ModifyPushChannelRequest req)
        {
            return InternalRequestAsync<ModifyPushChannelResponse>(req, "ModifyPushChannel");
        }
