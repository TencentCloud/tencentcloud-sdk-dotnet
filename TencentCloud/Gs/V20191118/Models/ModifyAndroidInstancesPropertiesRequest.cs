...
namespace TencentCloud.Gs.V20191118.Models
{
    ...
    public class ModifyAndroidInstancesPropertiesRequest : AbstractModel
    {
        ...
        /// 安卓实例设备
        /// </summary>
        [JsonProperty("AndroidInstanceDevice")]
        public AndroidInstanceDevice AndroidInstanceDevice{ get; set; }

        /// <summary>
        /// 安卓实例其它属性列表
        /// </summary>
        [JsonProperty("AndroidInstanceProperties")]
        public AndroidInstanceProperty[] AndroidInstanceProperties{ get; set; }
