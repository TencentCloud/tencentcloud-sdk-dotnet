...
namespace TencentCloud.Ig.V20210518.Models
{
    ...
    public class GetLLMReportInterpretationRequest : AbstractModel
    {
        ...
        /// <p>报告文件信息</p>
        /// </summary>
        [JsonProperty("ReportFileInfos")]
        public ReportFileInfoReq[] ReportFileInfos{ get; set; }
        ...
        /// <p>无报告问答提示词</p>
        /// </summary>
        [JsonProperty("QaPrompt")]
        public string QaPrompt{ get; set; }
