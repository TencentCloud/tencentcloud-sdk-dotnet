...
namespace TencentCloud.Ig.V20210518.Models
{
    ...
    public class LLMDiagnosisHealthData : AbstractModel
    {
        ...
        /// <p>风险提示</p>
        /// </summary>
        [JsonProperty("RiskReminder")]
        public string RiskReminder{ get; set; }
        ...
        public HealthFollowUpQuestion[] FollowUpQuestions{ get; set; }

        /// <summary>
        /// <p>药品列表，流式输出方式，只在流式结束输出结果。</p>
        /// </summary>
        [JsonProperty("DrugList")]
        public StandardDrugCardInfo[] DrugList{ get; set; }
