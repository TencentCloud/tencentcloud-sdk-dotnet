...
namespace TencentCloud.Ess.V20201111.Models
{
    ...
    public class CreateOrganizationAuthFileRequest : AbstractModel
    {
        
        /// <summary>
        /// 企业授权书信息参数， 需要自行保证这些参数跟营业执照中的信息一致。
        /// </summary>
        [JsonProperty("OrganizationCommonInfo")]
        public OrganizationCommonInfo OrganizationCommonInfo{ get; set; }
