...
namespace TencentCloud.Ess.V20201111.Models
{
    ...
    public class UpdateIntegrationEmployeesResponse : AbstractModel
    {
        ...
        public SuccessUpdateStaffData[] SuccessEmployeeData{ get; set; }

        /// <summary>
        /// 更新失败的用户列表
        /// </summary>
        [JsonProperty("FailedEmployeeData")]
        public FailedUpdateStaffData[] FailedEmployeeData{ get; set; }
