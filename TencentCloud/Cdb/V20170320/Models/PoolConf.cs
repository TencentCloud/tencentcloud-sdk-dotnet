...
namespace TencentCloud.Cdb.V20170320.Models
{
    ...
    public class PoolConf : AbstractModel
    {
        ...
        /// 注意：此字段可能返回 null，表示取不到有效值。
        /// </summary>
        [JsonProperty("MaxPoolConnectionTimeOut")]
        public long? MaxPoolConnectionTimeOut{ get; set; }

        /// <summary>
        /// 最小可保持连接阈值：单位（秒）
        /// 注意：此字段可能返回 null，表示取不到有效值。
        /// </summary>
        [JsonProperty("MinPoolConnectionTimeOut")]
        public long? MinPoolConnectionTimeOut{ get; set; }
