...
namespace TencentCloud.Tdmq.V20200217.Models
{
    ...
    public class DescribeAMQPClusterResponse : AbstractModel
    {
        ...
        public AMQPClusterInfo ClusterInfo{ get; set; }

        /// <summary>
        /// 集群配置
        /// </summary>
        [JsonProperty("ClusterConfig")]
        public AMQPClusterConfig ClusterConfig{ get; set; }
        ...
        public AMQPClusterRecentStats ClusterStats{ get; set; }
