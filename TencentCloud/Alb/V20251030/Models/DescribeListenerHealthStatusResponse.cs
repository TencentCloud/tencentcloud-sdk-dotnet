...
namespace TencentCloud.Alb.V20251030.Models
{
    ...
    public class DescribeListenerHealthStatusResponse : AbstractModel
    {
        ...
        /// 转发规则健康状态。
        /// </summary>
        [JsonProperty("RuleHealthStatusInfos")]
        public RuleHealthStatusInfo[] RuleHealthStatusInfos{ get; set; }
