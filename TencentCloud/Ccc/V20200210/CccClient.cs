...
namespace TencentCloud.Ccc.V20200210
{
   ...
   public class CccClient : AbstractClient{
       ...
       private const string sdkVersion = "SDK_NET_3.0.1377";
        ...
        /// 获取闪信记录列表
        /// </summary>
        /// <param name="req"><see cref="DescribeFlashSMSListRequest"/></param>
        /// <returns><see cref="DescribeFlashSMSListResponse"/></returns>
        public Task<DescribeFlashSMSListResponse> DescribeFlashSMSList(DescribeFlashSMSListRequest req)
        {
            return InternalRequestAsync<DescribeFlashSMSListResponse>(req, "DescribeFlashSMSList");
        }
        ...
        /// <param name="req"><see cref="DescribeFlashSMSListRequest"/></param>
        /// <returns><see cref="DescribeFlashSMSListResponse"/></returns>
        public DescribeFlashSMSListResponse DescribeFlashSMSListSync(DescribeFlashSMSListRequest req)
        {
            return InternalRequestAsync<DescribeFlashSMSListResponse>(req, "DescribeFlashSMSList")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
