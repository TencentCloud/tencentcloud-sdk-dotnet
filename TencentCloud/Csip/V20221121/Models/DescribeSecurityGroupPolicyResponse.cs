...
namespace TencentCloud.Csip.V20221121.Models
{
    ...
    public class DescribeSecurityGroupPolicyResponse : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("Egress")]
        public SecurityGroupPolicyItem[] Egress{ get; set; }

        /// <summary>
        /// 入站规则
        /// </summary>
        [JsonProperty("Ingress")]
        public SecurityGroupPolicyItem[] Ingress{ get; set; }
