...
namespace TencentCloud.Csip.V20221121.Models
{
    ...
    public class DescribeDspmAssetLoginCredentialResponse : AbstractModel
    {
        ...
        /// 有效期开始时间
        /// </summary>
        [JsonProperty("ValidateStart")]
        public string ValidateStart{ get; set; }

        /// <summary>
        /// 有效期结束时间
        /// </summary>
        [JsonProperty("ValidateEnd")]
