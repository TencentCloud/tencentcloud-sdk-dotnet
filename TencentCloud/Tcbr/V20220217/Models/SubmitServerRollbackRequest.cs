...
namespace TencentCloud.Tcbr.V20220217.Models
{
    ...
    public class SubmitServerRollbackRequest : AbstractModel
    {
        ...
        /// 当前版本
        /// </summary>
        [JsonProperty("CurrentVersionName")]
        public string CurrentVersionName{ get; set; }

        /// <summary>
        /// 回滚版本
        /// </summary>
        [JsonProperty("RollbackVersionName")]
        public string RollbackVersionName{ get; set; }
