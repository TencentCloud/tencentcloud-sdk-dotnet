...
namespace TencentCloud.Waf.V20180125.Models
{
    ...
    public class ModifyBotSceneUCBRuleRequest : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("Rule")]
        public InOutputBotUCBRule Rule{ get; set; }

        /// <summary>
        /// 530改批量操作
        /// </summary>
        [JsonProperty("BatchRules")]
        public InOutputBotUCBRule[] BatchRules{ get; set; }
