...
namespace TencentCloud.Omics.V20221128.Models
{
    ...
    public class RunGroupNotification : AbstractModel
    {
        ...
        public RunGroupResultNotification ResultNotification{ get; set; }

        /// <summary>
        /// 超时通知。
        /// </summary>
        [JsonProperty("TimeoutNotification")]
        public RunGroupTimeoutNotification TimeoutNotification{ get; set; }
