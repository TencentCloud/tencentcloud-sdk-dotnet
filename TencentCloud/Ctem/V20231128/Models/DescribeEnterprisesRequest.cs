...
namespace TencentCloud.Ctem.V20231128.Models
{
    ...
    public class DescribeEnterprisesRequest : AbstractModel
    {
        ...
        public override void ToMap(Dictionary<string, string> map, string prefix)
        {
            ...
            this.SetParamSimple(map, prefix + "IsShowStatistics", this.IsShowStatistics);
        }
    }
}
