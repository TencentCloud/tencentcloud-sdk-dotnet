...
namespace TencentCloud.Ms.V20180408.Models
{
    ...
    public class DescribeShieldPlanInstanceResponse : AbstractModel
    {
        ...
        /// 加固策略信息
        /// </summary>
        [JsonProperty("ShieldPlanInfo")]
        public ShieldPlanInfo ShieldPlanInfo{ get; set; }

        /// <summary>
        /// 加固资源信息
        /// </summary>
        [JsonProperty("ResourceServiceInfo")]
        public ResourceServiceInfo ResourceServiceInfo{ get; set; }
