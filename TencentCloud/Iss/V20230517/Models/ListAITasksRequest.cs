...
namespace TencentCloud.Iss.V20230517.Models
{
    ...
    public class ListAITasksRequest : AbstractModel
    {
        
        /// <summary>
        /// 是否包含通道列表。"true"代表包含通道列表，"false"代表不包含通道列表，默认为 false
        /// </summary>
        [JsonProperty("IsContainChannelList")]
        public bool? IsContainChannelList{ get; set; }

        /// <summary>
        /// 是否包含AI配置。"true"代表包含任务配置，"false"代表不包含任务配置，默认为 false。
        /// </summary>
        [JsonProperty("IsContainTemplate")]
        public bool? IsContainTemplate{ get; set; }
