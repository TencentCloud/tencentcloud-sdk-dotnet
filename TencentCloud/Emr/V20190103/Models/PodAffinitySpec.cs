...
namespace TencentCloud.Emr.V20190103.Models
{
    ...
    public class PodAffinitySpec : AbstractModel
    {
        ...
        public PodAffinityTerm[] RequiredDuringSchedulingIgnoredDuringExecution{ get; set; }

        /// <summary>
        /// <p>调度软关联规则</p>
        /// </summary>
        [JsonProperty("PreferredDuringSchedulingIgnoredDuringExecution")]
        public WeightedPodAffinityTerm[] PreferredDuringSchedulingIgnoredDuringExecution{ get; set; }
