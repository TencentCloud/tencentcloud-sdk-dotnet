...
namespace TencentCloud.Emr.V20190103.Models
{
    ...
    public class DescribeCvmQuotaResponse : AbstractModel
    {
        ...
        public QuotaEntity[] PostPaidQuotaSet{ get; set; }
        ...
        public QuotaEntity[] SpotPaidQuotaSet{ get; set; }

        /// <summary>
        /// eks配额
        /// 注意：此字段可能返回 null，表示取不到有效值。
        /// </summary>
        [JsonProperty("EksQuotaSet")]
        public PodSaleSpec[] EksQuotaSet{ get; set; }
