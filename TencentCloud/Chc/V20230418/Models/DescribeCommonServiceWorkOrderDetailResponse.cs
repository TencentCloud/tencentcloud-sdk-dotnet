...
namespace TencentCloud.Chc.V20230418.Models
{
    ...
    public class DescribeCommonServiceWorkOrderDetailResponse : AbstractModel
    {
        ...
        public CommonServiceBaseInfo BaseInfo{ get; set; }

        /// <summary>
        /// 设备信息
        /// </summary>
        [JsonProperty("DeviceSet")]
        public DevicePosition[] DeviceSet{ get; set; }
