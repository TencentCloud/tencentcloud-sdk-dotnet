...
namespace TencentCloud.Tcb.V20180608.Models
{
    ...
    public class EmailTemplateConfig : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("RegisterSignIn")]
        public LocalizedTemplate RegisterSignIn{ get; set; }
        ...
        /// 注意：此字段可能返回 null，表示取不到有效值。
        /// </summary>
        [JsonProperty("DefaultTpl")]
        public LocalizedTemplate DefaultTpl{ get; set; }
