...
namespace TencentCloud.Tcb.V20180608.Models
{
    ...
    public class DescribePlatformEnvUsageResponse : AbstractModel
    {
        ...
        public PlatformResUsageItem[] Resources{ get; set; }
        ...
        /// <p>资源点取整倍数</p>
        /// </summary>
        [JsonProperty("CreditsScale")]
        public ulong? CreditsScale{ get; set; }
