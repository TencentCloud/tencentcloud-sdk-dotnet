...
namespace TencentCloud.Tcb.V20180608.Models
{
    ...
    public class PlatformCreditsUsageDaily : AbstractModel
    {
        ...
        /// <p>资源点原价消耗</p>
        /// </summary>
        [JsonProperty("OriginCredits")]
        public float? OriginCredits{ get; set; }
        ...
        public override void ToMap(Dictionary<string, string> map, string prefix)
        {
            ...
            this.SetParamSimple(map, prefix + "OriginCredits", this.OriginCredits);
        }
    }
}
