...
namespace TencentCloud.Tcb.V20180608
{
   ...
   public class TcbClient : AbstractClient{
       ...
       private const string sdkVersion = "SDK_NET_3.0.1486";
        ...
        /// }
        /// </summary>
        /// <param name="req"><see cref="CreateCustomLoginKeyRequest"/></param>
        /// <returns><see cref="CreateCustomLoginKeyResponse"/></returns>
        public Task<CreateCustomLoginKeyResponse> CreateCustomLoginKey(CreateCustomLoginKeyRequest req)
        {
            return InternalRequestAsync<CreateCustomLoginKeyResponse>(req, "CreateCustomLoginKey");
        }
        ...
        /// <param name="req"><see cref="CreateCustomLoginKeyRequest"/></param>
        /// <returns><see cref="CreateCustomLoginKeyResponse"/></returns>
        public CreateCustomLoginKeyResponse CreateCustomLoginKeySync(CreateCustomLoginKeyRequest req)
        {
            return InternalRequestAsync<CreateCustomLoginKeyResponse>(req, "CreateCustomLoginKey")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// <returns><see cref="ExecutePGSqlResponse"/></returns>
        public Task<ExecutePGSqlResponse> ExecutePGSql(ExecutePGSqlRequest req)
        {
            return InternalRequestAsync<ExecutePGSqlResponse>(req, "ExecutePGSql");
        }
        ...
        /// <param name="req"><see cref="ExecutePGSqlRequest"/></param>
        /// <returns><see cref="ExecutePGSqlResponse"/></returns>
        public ExecutePGSqlResponse ExecutePGSqlSync(ExecutePGSqlRequest req)
        {
            return InternalRequestAsync<ExecutePGSqlResponse>(req, "ExecutePGSql")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </summary>
        /// <param name="req"><see cref="VerifyHTTPServiceRouteRequest"/></param>
        /// <returns><see cref="VerifyHTTPServiceRouteResponse"/></returns>
        public Task<VerifyHTTPServiceRouteResponse> VerifyHTTPServiceRoute(VerifyHTTPServiceRouteRequest req)
        {
            return InternalRequestAsync<VerifyHTTPServiceRouteResponse>(req, "VerifyHTTPServiceRoute");
        }
        ...
        /// <param name="req"><see cref="VerifyHTTPServiceRouteRequest"/></param>
        /// <returns><see cref="VerifyHTTPServiceRouteResponse"/></returns>
        public VerifyHTTPServiceRouteResponse VerifyHTTPServiceRouteSync(VerifyHTTPServiceRouteRequest req)
        {
            return InternalRequestAsync<VerifyHTTPServiceRouteResponse>(req, "VerifyHTTPServiceRoute")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
