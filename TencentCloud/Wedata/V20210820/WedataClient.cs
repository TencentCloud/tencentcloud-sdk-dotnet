...
namespace TencentCloud.Wedata.V20210820
{
   ...
   public class WedataClient : AbstractClient{
       ...
       private const string sdkVersion = "SDK_NET_3.0.1370";
        ...
        /// 分组获取编排空间调试任务实例状态信息
        /// </summary>
        /// <param name="req"><see cref="DescribeTaskInstancesStatusRequest"/></param>
        /// <returns><see cref="DescribeTaskInstancesStatusResponse"/></returns>
        public Task<DescribeTaskInstancesStatusResponse> DescribeTaskInstancesStatus(DescribeTaskInstancesStatusRequest req)
        {
            return InternalRequestAsync<DescribeTaskInstancesStatusResponse>(req, "DescribeTaskInstancesStatus");
        }
        ...
        /// <param name="req"><see cref="DescribeTaskInstancesStatusRequest"/></param>
        /// <returns><see cref="DescribeTaskInstancesStatusResponse"/></returns>
        public DescribeTaskInstancesStatusResponse DescribeTaskInstancesStatusSync(DescribeTaskInstancesStatusRequest req)
        {
            return InternalRequestAsync<DescribeTaskInstancesStatusResponse>(req, "DescribeTaskInstancesStatus")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// 获取编排空间试运行历史
        /// </summary>
        /// <param name="req"><see cref="DescribeTestRunningRecordRequest"/></param>
        /// <returns><see cref="DescribeTestRunningRecordResponse"/></returns>
        public Task<DescribeTestRunningRecordResponse> DescribeTestRunningRecord(DescribeTestRunningRecordRequest req)
        {
            return InternalRequestAsync<DescribeTestRunningRecordResponse>(req, "DescribeTestRunningRecord");
        }
        ...
        /// <param name="req"><see cref="DescribeTestRunningRecordRequest"/></param>
        /// <returns><see cref="DescribeTestRunningRecordResponse"/></returns>
        public DescribeTestRunningRecordResponse DescribeTestRunningRecordSync(DescribeTestRunningRecordRequest req)
        {
            return InternalRequestAsync<DescribeTestRunningRecordResponse>(req, "DescribeTestRunningRecord")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
