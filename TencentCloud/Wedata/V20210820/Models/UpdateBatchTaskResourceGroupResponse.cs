...
namespace TencentCloud.Wedata.V20210820.Models
{
    ...
    public class UpdateBatchTaskResourceGroupResponse : AbstractModel
    {
        ...
        public ulong? SuccessNumber{ get; set; }

        /// <summary>
        /// 1
        /// 注意：此字段可能返回 null，表示取不到有效值。
        /// </summary>
        [JsonProperty("FailNumber")]
        public ulong? FailNumber{ get; set; }
        ...
        /// </summary>
        [JsonProperty("Data")]
        public BatchTaskOperateNew Data{ get; set; }
