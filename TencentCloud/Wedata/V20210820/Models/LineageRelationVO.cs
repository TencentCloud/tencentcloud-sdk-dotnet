...
namespace TencentCloud.Wedata.V20210820.Models
{
    ...
    public class LineageRelationVO : AbstractModel
    {
        ...
        /// 注意：此字段可能返回 null，表示取不到有效值。
        /// </summary>
        [JsonProperty("SourceQualifiedId")]
        public string SourceQualifiedId{ get; set; }

        /// <summary>
        /// 目标端唯一血缘ID
        /// 注意：此字段可能返回 null，表示取不到有效值。
        /// </summary>
        [JsonProperty("TargetQualifiedId")]
        public string TargetQualifiedId{ get; set; }
        ...
        public LineageProcessVO[] Processes{ get; set; }
