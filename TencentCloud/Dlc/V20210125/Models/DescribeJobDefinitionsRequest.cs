...
namespace TencentCloud.Dlc.V20210125.Models
{
    ...
    public class DescribeJobDefinitionsRequest : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("InstanceTimeRange")]
        public long? InstanceTimeRange{ get; set; }
        ...
        public override void ToMap(Dictionary<string, string> map, string prefix)
        {
            ...
            this.SetParamSimple(map, prefix + "InstanceTimeRange", this.InstanceTimeRange);
        }
    }
}
