...
namespace TencentCloud.Dlc.V20210125.Models
{
    ...
    public class UpdateStandardEngineResourceGroupConfigInfoRequest : AbstractModel
    {
        ...
        /// 需要更新的配置
        /// </summary>
        [JsonProperty("UpdateConfContext")]
        public UpdateConfContext[] UpdateConfContext{ get; set; }
