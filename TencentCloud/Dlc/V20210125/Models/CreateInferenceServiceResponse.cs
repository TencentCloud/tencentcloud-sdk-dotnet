...
namespace TencentCloud.Dlc.V20210125.Models
{
    ...
    public class CreateInferenceServiceResponse : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("ApiKeyBindMessage")]
        public string ApiKeyBindMessage{ get; set; }
        ...
        public override void ToMap(Dictionary<string, string> map, string prefix)
        {
            ...
            this.SetParamSimple(map, prefix + "ApiKeyBindMessage", this.ApiKeyBindMessage);
