...
namespace TencentCloud.Dlc.V20210125.Models
{
    ...
    public class DescribeNativeSparkSessionsResponse : AbstractModel
    {
        
        /// <summary>
        /// spark session列表
        /// </summary>
        [JsonProperty("SparkSessionsList")]
        public SparkSessionInfo[] SparkSessionsList{ get; set; }

        /// <summary>
        /// 资源组总规格
        /// </summary>
        [JsonProperty("TotalSpec")]
        public long? TotalSpec{ get; set; }
