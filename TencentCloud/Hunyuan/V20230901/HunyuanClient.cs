...
namespace TencentCloud.Hunyuan.V20230901
{
   ...
   public class HunyuanClient : AbstractClient{
       ...
       private const string sdkVersion = "SDK_NET_3.0.1332";
        ...
        ///  4. 我们推荐您使用 API Explorer，方便快速地在线调试接口和下载各语言的示例代码，[点击打开](https://console.cloud.tencent.com/api/explorer?Product=hunyuan&Version=2023-09-01&Action=ChatCompletions)。
        /// </summary>
        /// <param name="req"><see cref="GroupChatCompletionsRequest"/></param>
        /// <returns><see cref="GroupChatCompletionsResponse"/></returns>
        public Task<GroupChatCompletionsResponse> GroupChatCompletions(GroupChatCompletionsRequest req)
        {
            return InternalRequestAsync<GroupChatCompletionsResponse>(req, "GroupChatCompletions");
        }
        ...
        /// <param name="req"><see cref="GroupChatCompletionsRequest"/></param>
        /// <returns><see cref="GroupChatCompletionsResponse"/></returns>
        public GroupChatCompletionsResponse GroupChatCompletionsSync(GroupChatCompletionsRequest req)
        {
            return InternalRequestAsync<GroupChatCompletionsResponse>(req, "GroupChatCompletions")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        ///  4. 我们推荐您使用 API Explorer，方便快速地在线调试接口和下载各语言的示例代码，[点击打开](https://console.cloud.tencent.com/api/explorer?Product=hunyuan&Version=2023-09-01&Action=ChatCompletions)。
        /// </summary>
        /// <param name="req"><see cref="ImageQuestionRequest"/></param>
        /// <returns><see cref="ImageQuestionResponse"/></returns>
        public Task<ImageQuestionResponse> ImageQuestion(ImageQuestionRequest req)
        {
            return InternalRequestAsync<ImageQuestionResponse>(req, "ImageQuestion");
        }
        ...
        /// <param name="req"><see cref="ImageQuestionRequest"/></param>
        /// <returns><see cref="ImageQuestionResponse"/></returns>
        public ImageQuestionResponse ImageQuestionSync(ImageQuestionRequest req)
        {
            return InternalRequestAsync<ImageQuestionResponse>(req, "ImageQuestion")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
