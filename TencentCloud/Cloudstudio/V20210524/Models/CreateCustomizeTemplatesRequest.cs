...
namespace TencentCloud.Cloudstudio.V20210524.Models
{
    ...
    public class CreateCustomizeTemplatesRequest : AbstractModel
    {
        ...
        /// 无
        /// </summary>
        [JsonProperty("UserDefinedTemplateParams")]
        public UserDefinedTemplateParams UserDefinedTemplateParams{ get; set; }
