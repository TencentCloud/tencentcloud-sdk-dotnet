...
namespace TencentCloud.Essbasic.V20210526
{
   ...
   public class EssbasicClient : AbstractClient{
       ...
       private const string sdkVersion = "SDK_NET_3.0.1463";
        ...
        /// </ul>
        /// </summary>
        /// <param name="req"><see cref="ChannelCreateDynamicFlowApproverRequest"/></param>
        /// <returns><see cref="ChannelCreateDynamicFlowApproverResponse"/></returns>
        public Task<ChannelCreateDynamicFlowApproverResponse> ChannelCreateDynamicFlowApprover(ChannelCreateDynamicFlowApproverRequest req)
        {
            return InternalRequestAsync<ChannelCreateDynamicFlowApproverResponse>(req, "ChannelCreateDynamicFlowApprover");
        }
        ...
        /// <param name="req"><see cref="ChannelCreateDynamicFlowApproverRequest"/></param>
        /// <returns><see cref="ChannelCreateDynamicFlowApproverResponse"/></returns>
        public ChannelCreateDynamicFlowApproverResponse ChannelCreateDynamicFlowApproverSync(ChannelCreateDynamicFlowApproverRequest req)
        {
            return InternalRequestAsync<ChannelCreateDynamicFlowApproverResponse>(req, "ChannelCreateDynamicFlowApprover")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </ul>
        /// </summary>
        /// <param name="req"><see cref="ChannelDescribeAccountBillDetailRequest"/></param>
        /// <returns><see cref="ChannelDescribeAccountBillDetailResponse"/></returns>
        public Task<ChannelDescribeAccountBillDetailResponse> ChannelDescribeAccountBillDetail(ChannelDescribeAccountBillDetailRequest req)
        {
            return InternalRequestAsync<ChannelDescribeAccountBillDetailResponse>(req, "ChannelDescribeAccountBillDetail");
        }
        ...
        /// <param name="req"><see cref="ChannelDescribeAccountBillDetailRequest"/></param>
        /// <returns><see cref="ChannelDescribeAccountBillDetailResponse"/></returns>
        public ChannelDescribeAccountBillDetailResponse ChannelDescribeAccountBillDetailSync(ChannelDescribeAccountBillDetailRequest req)
        {
            return InternalRequestAsync<ChannelDescribeAccountBillDetailResponse>(req, "ChannelDescribeAccountBillDetail")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </summary>
        /// <param name="req"><see cref="CreateChannelSubOrganizationActiveRequest"/></param>
        /// <returns><see cref="CreateChannelSubOrganizationActiveResponse"/></returns>
        public Task<CreateChannelSubOrganizationActiveResponse> CreateChannelSubOrganizationActive(CreateChannelSubOrganizationActiveRequest req)
        {
            return InternalRequestAsync<CreateChannelSubOrganizationActiveResponse>(req, "CreateChannelSubOrganizationActive");
        }
        ...
        /// <param name="req"><see cref="CreateChannelSubOrganizationActiveRequest"/></param>
        /// <returns><see cref="CreateChannelSubOrganizationActiveResponse"/></returns>
        public CreateChannelSubOrganizationActiveResponse CreateChannelSubOrganizationActiveSync(CreateChannelSubOrganizationActiveRequest req)
        {
            return InternalRequestAsync<CreateChannelSubOrganizationActiveResponse>(req, "CreateChannelSubOrganizationActive")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </summary>
        /// <param name="req"><see cref="CreateCloseOrganizationUrlRequest"/></param>
        /// <returns><see cref="CreateCloseOrganizationUrlResponse"/></returns>
        public Task<CreateCloseOrganizationUrlResponse> CreateCloseOrganizationUrl(CreateCloseOrganizationUrlRequest req)
        {
            return InternalRequestAsync<CreateCloseOrganizationUrlResponse>(req, "CreateCloseOrganizationUrl");
        }
        ...
        /// <param name="req"><see cref="CreateCloseOrganizationUrlRequest"/></param>
        /// <returns><see cref="CreateCloseOrganizationUrlResponse"/></returns>
        public CreateCloseOrganizationUrlResponse CreateCloseOrganizationUrlSync(CreateCloseOrganizationUrlRequest req)
        {
            return InternalRequestAsync<CreateCloseOrganizationUrlResponse>(req, "CreateCloseOrganizationUrl")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </summary>
        /// <param name="req"><see cref="ModifyOrganizationBusinessInfoRequest"/></param>
        /// <returns><see cref="ModifyOrganizationBusinessInfoResponse"/></returns>
        public Task<ModifyOrganizationBusinessInfoResponse> ModifyOrganizationBusinessInfo(ModifyOrganizationBusinessInfoRequest req)
        {
            return InternalRequestAsync<ModifyOrganizationBusinessInfoResponse>(req, "ModifyOrganizationBusinessInfo");
        }
        ...
        /// <param name="req"><see cref="ModifyOrganizationBusinessInfoRequest"/></param>
        /// <returns><see cref="ModifyOrganizationBusinessInfoResponse"/></returns>
        public ModifyOrganizationBusinessInfoResponse ModifyOrganizationBusinessInfoSync(ModifyOrganizationBusinessInfoRequest req)
        {
            return InternalRequestAsync<ModifyOrganizationBusinessInfoResponse>(req, "ModifyOrganizationBusinessInfo")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
