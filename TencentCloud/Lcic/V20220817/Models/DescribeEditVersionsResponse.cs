...
namespace TencentCloud.Lcic.V20220817.Models
{
    ...
    public class DescribeEditVersionsResponse : AbstractModel
    {
        ...
        public ulong? LatestVersionNo{ get; set; }

        /// <summary>
        /// <p>当前课堂设置的主版本号</p>
        /// </summary>
        [JsonProperty("MainVersion")]
        public ulong? MainVersion{ get; set; }

        /// <summary>
        /// <p>当前课堂所有版本信息</p>
        /// </summary>
        [JsonProperty("Versions")]
        public EditVersions[] Versions{ get; set; }
