...
namespace TencentCloud.Cfw.V20190904
{
   ...
   public class CfwClient : AbstractClient{
       ...
       private const string sdkVersion = "SDK_NET_3.0.1510";
        ...
        /// </summary>
        /// <param name="req"><see cref="DescribeNDRAssetIdentificationCursorListRequest"/></param>
        /// <returns><see cref="DescribeNDRAssetIdentificationCursorListResponse"/></returns>
        public Task<DescribeNDRAssetIdentificationCursorListResponse> DescribeNDRAssetIdentificationCursorList(DescribeNDRAssetIdentificationCursorListRequest req)
        {
            return InternalRequestAsync<DescribeNDRAssetIdentificationCursorListResponse>(req, "DescribeNDRAssetIdentificationCursorList");
        }
        ...
        /// <param name="req"><see cref="DescribeNDRAssetIdentificationCursorListRequest"/></param>
        /// <returns><see cref="DescribeNDRAssetIdentificationCursorListResponse"/></returns>
        public DescribeNDRAssetIdentificationCursorListResponse DescribeNDRAssetIdentificationCursorListSync(DescribeNDRAssetIdentificationCursorListRequest req)
        {
            return InternalRequestAsync<DescribeNDRAssetIdentificationCursorListResponse>(req, "DescribeNDRAssetIdentificationCursorList")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </summary>
        /// <param name="req"><see cref="DescribeNDRDataLeakOutAlertListRequest"/></param>
        /// <returns><see cref="DescribeNDRDataLeakOutAlertListResponse"/></returns>
        public Task<DescribeNDRDataLeakOutAlertListResponse> DescribeNDRDataLeakOutAlertList(DescribeNDRDataLeakOutAlertListRequest req)
        {
            return InternalRequestAsync<DescribeNDRDataLeakOutAlertListResponse>(req, "DescribeNDRDataLeakOutAlertList");
        }
        ...
        /// <param name="req"><see cref="DescribeNDRDataLeakOutAlertListRequest"/></param>
        /// <returns><see cref="DescribeNDRDataLeakOutAlertListResponse"/></returns>
        public DescribeNDRDataLeakOutAlertListResponse DescribeNDRDataLeakOutAlertListSync(DescribeNDRDataLeakOutAlertListRequest req)
        {
            return InternalRequestAsync<DescribeNDRDataLeakOutAlertListResponse>(req, "DescribeNDRDataLeakOutAlertList")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// 查询NAT边界防火墙开关列表
        /// </summary>
        /// <param name="req"><see cref="DescribeNatFwSwitchRequest"/></param>
        /// <returns><see cref="DescribeNatFwSwitchResponse"/></returns>
        public Task<DescribeNatFwSwitchResponse> DescribeNatFwSwitch(DescribeNatFwSwitchRequest req)
        {
            return InternalRequestAsync<DescribeNatFwSwitchResponse>(req, "DescribeNatFwSwitch");
        }
        ...
        /// <param name="req"><see cref="DescribeNatFwSwitchRequest"/></param>
        /// <returns><see cref="DescribeNatFwSwitchResponse"/></returns>
        public DescribeNatFwSwitchResponse DescribeNatFwSwitchSync(DescribeNatFwSwitchRequest req)
        {
            return InternalRequestAsync<DescribeNatFwSwitchResponse>(req, "DescribeNatFwSwitch")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
