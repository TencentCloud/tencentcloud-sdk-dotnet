...
namespace TencentCloud.Dsgc.V20190723.Models
{
    ...
    public class DescribeRDBAssetSensitiveDistributionResponse : AbstractModel
    {
        ...
        {
            this.SetParamObj(map, prefix + "RDBAsset.", this.RDBAsset);
            this.SetParamArrayObj(map, prefix + "TopAsset.", this.TopAsset);
            this.SetParamArrayObj(map, prefix + "RDBDetail.", this.RDBDetail);
