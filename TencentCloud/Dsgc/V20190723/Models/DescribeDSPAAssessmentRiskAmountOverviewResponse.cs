...
namespace TencentCloud.Dsgc.V20190723.Models
{
    ...
    public class DescribeDSPAAssessmentRiskAmountOverviewResponse : AbstractModel
    {
        ...
        /// 受影响的资产数
        /// </summary>
        [JsonProperty("TotalAffectedAssetCount")]
        public long? TotalAffectedAssetCount{ get; set; }
