...
namespace TencentCloud.Ssl.V20191205.Models
{
    ...
    public class DescribeHostDeployRecordDetailResponse : AbstractModel
    {
        ...
        /// 证书部署记录列表
        /// </summary>
        [JsonProperty("DeployRecordDetailList")]
        public DeployRecordDetail[] DeployRecordDetailList{ get; set; }
