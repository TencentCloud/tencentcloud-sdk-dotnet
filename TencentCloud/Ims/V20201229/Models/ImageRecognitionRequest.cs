...
namespace TencentCloud.Ims.V20201229.Models
{
    ...
    public class ImageRecognitionRequest : AbstractModel
    {
        ...
        /// 产品侧腾讯云用户账号Uin
        /// </summary>
        [JsonProperty("CustomUin")]
        public string CustomUin{ get; set; }

        /// <summary>
        /// 产品侧腾讯云用户子账号Uin
        /// </summary>
        [JsonProperty("CustomSubAccountUin")]
        public string CustomSubAccountUin{ get; set; }
