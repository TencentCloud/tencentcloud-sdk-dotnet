...
namespace TencentCloud.Captcha.V20190722.Models
{
    ...
    public class InterceptPerTrendObj : AbstractModel
    {
        ...
        /// 拦截率
        /// </summary>
        [JsonProperty("RequestInterceptPer")]
        public float? RequestInterceptPer{ get; set; }

        /// <summary>
        /// 答案拦截率
        /// </summary>
        [JsonProperty("AnswerInterceptPer")]
        public float? AnswerInterceptPer{ get; set; }

        /// <summary>
        /// 策略拦截率
        /// </summary>
        [JsonProperty("PolicyInterceptPer")]
        public float? PolicyInterceptPer{ get; set; }
