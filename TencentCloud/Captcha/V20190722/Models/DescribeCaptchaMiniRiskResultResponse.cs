...
namespace TencentCloud.Captcha.V20190722.Models
{
    ...
    public class DescribeCaptchaMiniRiskResultResponse : AbstractModel
    {
        ...
        /// 注意：此字段可能返回 null，表示取不到有效值。
        /// </summary>
        [JsonProperty("ManageMarketingRiskValue")]
        public OutputManageMarketingRiskValue ManageMarketingRiskValue{ get; set; }
